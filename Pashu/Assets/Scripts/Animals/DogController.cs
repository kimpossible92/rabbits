...
public class DogController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentState == State.goToFood|| currentState == State.goToWater)
        {
            ...
            if (findClosestResourceWithTag("rabbit") != null)
            {
                ...
                if (target != null)
                {
                    ...
                    {
                        FindObjectOfType<cameraController>().DeleteAnimal(findClosestResourceWithTag("rabbit").GetComponent<AnimalController>());
